...
SoundStream AudioController::createDefaultStreamFromDevice(
...
void AudioController::sleep(long ms) { Pa_Sleep(ms); }

SoundStream AudioController::createStream(PaStreamParameters *outputStream,
